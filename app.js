...
const ARTIGOS_BIBLIOTECA = [
  ...
  {
    id: "novo-medicamento-fda-2025",
    publicado: true,
    autorTipo: "editorial",
    tag: "🆕 Novidade Científica • FDA 2025",
    titulo: "💊 Primeiro novo medicamento para fibromialgia em 15 anos",
    preview: "Em agosto de 2025, o FDA aprovou a ciclobenzaprina sublingual — uma nova classe terapêutica que age sobre o sono não restaurador, causa central da dor na fibromialgia.",
    intro: "Uma notícia que a comunidade científica esperava há muito tempo: pela primeira vez em mais de 15 anos, um medicamento com mecanismo de ação inédito foi aprovado para o tratamento da fibromialgia.",
    corpo: [
      { tipo: "destaque", texto: "Em agosto de 2025, o FDA (agência reguladora americana) aprovou a <strong>ciclobenzaprina sublingual</strong> (nome comercial Tonmya) — o primeiro novo medicamento para fibromialgia desde a aprovação da pregabalina em 2007." },
      { tipo: "sintoma", icon: "🌙", titulo: "Como funciona", texto: "Tomado uma vez ao deitar, o Tonmya age diretamente sobre o sono não restaurador — reconhecido hoje como uma das causas centrais da dor, da fadiga e do fibro fog. Ao melhorar a qualidade do sono, ele interrompe o ciclo vicioso que mantém a doença ativa." },
      { tipo: "sintoma", icon: "🚫", titulo: "Não é opioide", texto: "Diferente de muitos tratamentos anteriores, a ciclobenzaprina sublingual não é um opioide e não causa dependência. Representa uma nova classe terapêutica, com perfil de segurança adequado para uso crônico." },
      { tipo: "sintoma", icon: "🇧🇷", titulo: "E no Brasil?", texto: "Ainda não há aprovação pela Anvisa para essa formulação específica. No entanto, os medicamentos com melhor evidência consolidada disponíveis no Brasil continuam sendo: duloxetina, pregabalina, amitriptilina e milnaciprano. A naltrexona em baixa dose (LDN) também mostra resultados promissores em estudos recentes." },
      { tipo: "texto", texto: "A aprovação do Tonmya é um marco importante: sinaliza que a indústria farmacêutica está novamente investindo em fibromialgia como área terapêutica relevante, após anos de estagnação." },
      { tipo: "destaque", texto: "Fique atento: novas pesquisas estão avançando sobre neuroinflamação e microbiota intestinal como alvos terapêuticos futuros. A ciência está evoluindo rapidamente." },
    ],
    cta: "💬 Converse com seu reumatologista sobre as opções de tratamento disponíveis.",
    autorNome: "Equipe FibroVida",
    autorSub: "Baseado em: FDA (ago/2025) • Medscape • Drug Discovery World • PubMed",
    fonteUrl: "https://portugues.medscape.com/verartigo/6513172",
    fonteLabel: "🔗 FDA aprova novo medicamento — Medscape",
    categorias: ["tratamento", "medicamento", "novidades", "ciencia"],
  },
  {
    id: "microbiota-neuroinflamacao-2025",
    publicado: true,
    autorTipo: "editorial",
    tag: "🔬 Pesquisa Científica • 2025",
    titulo: "🧠 Fibromialgia, intestino e cérebro: o que a ciência descobriu",
    preview: "Estudos de 2025 mostram que a microbiota intestinal pode ter papel central na fibromialgia — e que a doença causa perda acelerada de matéria cinzenta cerebral.",
    intro: "Dois achados científicos de 2025 estão mudando a forma como entendemos a fibromialgia — e abrindo novos caminhos para tratamentos futuros.",
    corpo: [
      { tipo: "destaque", texto: "A fibromialgia não é \"coisa da cabeça\" no sentido pejorativo. Mas literalmente envolve o cérebro — e agora também o intestino." },
      { tipo: "sintoma", icon: "🦠", titulo: "O eixo intestino-cérebro", texto: "Um estudo publicado no Lancet Rheumatology (2025) demonstrou que ao transferir a microbiota intestinal de pacientes com fibromialgia para camundongos saudáveis, os animais desenvolveram sensibilidade à dor semelhante à da doença. Quando a microbiota foi substituída por uma saudável, a dor reduziu significativamente." },
      { tipo: "sintoma", icon: "⚡", titulo: "O que isso significa", texto: "Isso sugere que desequilíbrios na flora intestinal (disbiose) podem contribuir para manter ou agravar a fibromialgia. Ainda não é um tratamento validado, mas reforça a importância da alimentação anti-inflamatória e da saúde digestiva no manejo da doença." },
      { tipo: "sintoma", icon: "🧠", titulo: "Neuroinflamação e perda cerebral", texto: "Pesquisas de 2025-2026 confirmam que pacientes com fibromialgia perdem matéria cinzenta cerebral 3,3 vezes mais rápido do que o esperado para a idade. Células imunes do cérebro (microglia e astrócitos) ficam cronicamente ativadas, liberando substâncias inflamatórias que amplificam a dor." },
      { tipo: "texto", texto: "Esses achados reforçam o que a SBR e o NEJM já afirmam: a fibromialgia é uma condição com substrato neurobiológico objetivo e mensurável — não é ansiedade, não é exagero, não é imaginação." },
      { tipo: "destaque", texto: "\"A fibromialgia é classificada como dor nociplástica — gerada por alterações no processamento central, com mecanismos reais e identificáveis.\" — NEJM, julho/2026" },
      { tipo: "sintoma", icon: "🥗", titulo: "O que você pode fazer agora", texto: "Dieta anti-inflamatória rica em fibras, probióticos naturais (iogurte, kefir), redução de ultraprocessados e exercício físico regular são estratégias que beneficiam tanto a microbiota quanto a neuroinflamação. Converse com seu médico sobre essas opções." },
    ],
    cta: "💜 Cuidar do intestino pode ser cuidar da dor.",
    autorNome: "Equipe FibroVida",
    autorSub: "Baseado em: Lancet Rheumatology 2025 • PubMed PMID 42328945 • Dor Crônica Blog",
    fonteUrl: "https://www.thelancet.com/journals/lanrhe/article/PIIS2665-9913(26)00051-2/fulltext",
    fonteLabel: "🔗 The Lancet Rheumatology — Fibromialgia 2026",
    categorias: ["ciencia", "neuroinflamacao", "microbiota", "novidades"],
  },
  {
    id: "lei-15176-direitos",
    publicado: true,
    autorTipo: "editorial",
    tag: "⚖️ Lei 15.176/2025 • Seus Direitos",
    titulo: "📋 Lei da Fibromialgia: conheça todos os seus direitos",
    preview: "Sancionada em julho de 2025, a Lei 15.176 reconhece a fibromialgia como deficiência e garante direitos no SUS, INSS e concursos públicos.",
    intro: "A maior conquista legislativa da história dos pacientes com fibromialgia no Brasil entrou em vigor em janeiro de 2026. Saiba o que mudou e como isso afeta você.",
    corpo: [
      { tipo: "destaque", texto: "Em 23 de julho de 2025, o presidente Lula sancionou a <strong>Lei 15.176/2025</strong>, que reconhece oficialmente a fibromialgia como condição equiparada à deficiência no Brasil." },
      { tipo: "sintoma", icon: "🏥", titulo: "Direito ao SUS ampliado", texto: "As novas diretrizes da SBR (2026) ampliaram as opções de tratamento disponíveis na rede pública. Você tem direito a atendimento prioritário e acesso a mais recursos terapêuticos pelo SUS — incluindo acompanhamento multidisciplinar." },
      { tipo: "sintoma", icon: "📝", titulo: "Concursos públicos e cotas", texto: "Pacientes com fibromialgia podem concorrer às vagas reservadas para pessoas com deficiência em concursos públicos, desde que a condição seja avaliada por equipe médica e comprovada a limitação funcional." },
      { tipo: "sintoma", icon: "💰", titulo: "Isenções fiscais", texto: "A lei garante isenção de IR sobre aposentadoria, pensão ou reforma para quem tem a doença comprovada — assim como acontece com outras condições equiparadas à deficiência." },
      { tipo: "destaque", texto: "⚠️ <strong>Importante sobre aposentadoria:</strong> O diagnóstico de fibromialgia por si só não garante aposentadoria por deficiência. É necessária avaliação biopsicossocial por equipe multidisciplinar do INSS, que analisa o grau de limitação funcional de cada caso individualmente." },
      { tipo: "sintoma", icon: "📋", titulo: "Como se preparar", texto: "Documente tudo: datas de crises, medicamentos, consultas, impacto no trabalho e na vida diária. O FibroVida gera relatório completo pronto para apresentar ao INSS, ao perito médico ou ao empregador." },
      { tipo: "texto", texto: "A fibromialgia afeta entre 2,5% e 3% da população brasileira — cerca de 5 milhões de pessoas. É a segunda doença reumatológica mais comum, atrás apenas da osteoartrite." },
    ],
    cta: "💜 Conhecer seus direitos é o primeiro passo para exercê-los.",
    autorNome: "Equipe FibroVida",
    autorSub: "Baseado em: Lei 15.176/2025 • SBR 2026 • Agência Brasil • CFM • Conjur",
    fonteUrl: "https://agenciabrasil.ebc.com.br/saude/noticia/2026-02/novas-diretrizes-ampliam-o-tratamento-de-fibromialgia-pelo-sus",
    fonteLabel: "🔗 Agência Brasil — Novas diretrizes SUS",
    categorias: ["direitos", "lei", "inss", "sus", "novidades"],
  },
];
